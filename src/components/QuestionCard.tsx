  ...
  return (
    <div className="flex items-center gap-6 w-full">
      ...
      <BorderRotate
        ...
        className={`flex-1 w-full max-w-lg mx-auto space-y-6 rounded-2xl p-8 shadow-md relative overflow-hidden transition-all duration-300 ${transitioning ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0 animate-slide-up'}`}
      >
